...
from wtforms import EmailField, PasswordField, SubmitField, StringField, IntegerField, SelectField, FileField
...
class RegisterForm(FlaskForm):
    ...
    sex = SelectField(
        "Пол",
        validators=[DataRequired(message=lang.get("data_required", ["Пол"]))],
        choices=[sex for sex in SEX_LIST]
    )
    email = EmailField(
        "Почта",
        validators=[
    ...
    avatar = FileField(
        "Файл",
        validators=[DataRequired(message=lang.get("file_required"))]
    )
